...
//                }
        ...
        <<"\tim2col\t"<<t_im2col<<"\tcsr\t" <<t_csr <<"\tcpo\t"<< t_cpo <<"\tcpo2\t"<< t_cpo2
        <<"\tpercent1\t"<< 100.0*(t_im2col-t_csr)/t_im2col  <<"\tpercent2\t"<< 100.0*(t_im2col-t_cpo)/t_im2col <<"\tpercent3\t"<< 100.0*(t_im2col-t_cpo2)/t_im2col  << "\n";
